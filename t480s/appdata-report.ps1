# T480S AppData + account report - READ-ONLY. Changes nothing, downloads nothing.
...
$out = Join-Path $env:USERPROFILE 'Desktop\T480S-AppData-Report.txt'
...
Add "T480S AppData report - $(Get-Date)"
