@echo off
rem ===================================================================
rem  T480S Step 2 - Clean junk files
...
rem  Log: Desktop\T480S-Logs\2-clean.log
rem ===================================================================
...
echo T480S clean started %DATE% %TIME% > "%LOG%"
...
wmic.exe /Namespace:\\root\default Path SystemRestore Call CreateRestorePoint "Before T480S clean", 100, 7 >> "%LOG%" 2>&1
