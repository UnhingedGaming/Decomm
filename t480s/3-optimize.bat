@echo off
rem ===================================================================
rem  T480S Step 3 - Health check and optimize
...
rem  Log: Desktop\T480S-Logs\3-optimize.log
rem ===================================================================
setlocal
title T480S Optimize
...
set "LOGDIR=%USERPROFILE%\Desktop\T480S-Logs"
if not exist "%LOGDIR%" mkdir "%LOGDIR%"
set "LOG=%LOGDIR%\3-optimize.log"
echo T480S optimize started %DATE% %TIME% > "%LOG%"
...
wmic.exe /Namespace:\\root\default Path SystemRestore Call CreateRestorePoint "Before T480S optimize", 100, 7 >> "%LOG%" 2>&1
