@echo off
rem ===================================================================
rem  T480S Step 1 - Inventory (READ-ONLY: changes and deletes nothing)
rem  Works on Windows 7, 8, 8.1 and 10.
rem  Output: Desktop\T480S-Inventory\
rem ===================================================================
setlocal EnableDelayedExpansion
title T480S Inventory
...
set "HERE=%~dp0"
set "OUT=%USERPROFILE%\Desktop\T480S-Inventory"
