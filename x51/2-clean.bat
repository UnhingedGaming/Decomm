@echo off
rem ===================================================================
rem  X51 Step 2 - Clean junk files
...
rem  Log: Desktop\X51-Logs\2-clean.log
rem ===================================================================
...
echo X51 clean started %DATE% %TIME% > "%LOG%"
...
wmic.exe /Namespace:\\root\default Path SystemRestore Call CreateRestorePoint "Before X51 clean", 100, 7 >> "%LOG%" 2>&1
