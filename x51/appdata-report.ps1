# X51 AppData + account report - READ-ONLY. Changes nothing, downloads nothing.
...
$out = Join-Path $env:USERPROFILE 'Desktop\X51-AppData-Report.txt'
...
Add "X51 AppData report - $(Get-Date)"
