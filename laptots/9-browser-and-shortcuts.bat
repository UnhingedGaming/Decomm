@echo off
rem ===================================================================
rem  LAPTOTS Step 9 - Copy browser bookmarks, quick links and shortcuts to USB
...
rem ===================================================================
setlocal
title LAPTOTS Browser and shortcuts backup
echo.
...
set "DEST=%USB%:\LapTots Rescue\Browsers and Shortcuts"
mkdir "%DEST%" 2>nul
