@echo off
rem ===================================================================
rem  LAPTOTS Step 5 - Gather every personal file into Desktop\LAPTOTS-Gathered
rem  Finds every real file on C: that isn't Windows or a program, wherever
rem  it is, and MOVES it into Desktop\LAPTOTS-Gathered keeping its folders.
