# LAPTOTS duplicate finder - READ-ONLY. Reports duplicates, never deletes or moves anything.
...
param(
    [string]$OutDir = (Join-Path ([Environment]::GetFolderPath('Desktop')) 'LAPTOTS-Inventory')
)
