@echo off
rem ===================================================================
rem  LAPTOTS Step 1 - Inventory (READ-ONLY: changes and deletes nothing)
rem  Works on Windows 7, 8, 8.1 and 10.
rem  Output: Desktop\LAPTOTS-Inventory\
rem ===================================================================
setlocal EnableDelayedExpansion
title LAPTOTS Inventory
...
set "HERE=%~dp0"
set "OUT=%USERPROFILE%\Desktop\LAPTOTS-Inventory"
